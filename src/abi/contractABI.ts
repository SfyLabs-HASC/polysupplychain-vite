...
// Questo è il "manuale di istruzioni" ufficiale del tuo contratto,
// esportato come una costante per un'importazione sicura.
		...
		"outputs": [
			{
				"components": [
					...
					},
					{
						...
						"internalType": "struct SupplyChainV2.Step[]",
						"name": "steps",
						"type": "tuple[]"
					}
				],
				"internalType": "struct SupplyChainV2.Batch",
				"name": "",
				"type": "tuple"
			}
		],
		...
		"outputs": [
			{
				...
				"internalType": "struct SupplyChainV2.Contributor",
				"name": "",
				"type": "tuple"
			}
		],
