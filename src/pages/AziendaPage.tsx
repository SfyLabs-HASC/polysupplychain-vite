...
// VERSIONE CON FILTRI IN-TABLE E REDIRECT AL LOGOUT
...
// MODIFICA: BatchTable ora contiene la UI dei filtri
const BatchTable = ({ 
    batches, 
...
export default function AziendaPage() {
    ...
    // MODIFICA: Logica per reindirizzare alla homepage dopo il logout
