...
// AGGIORNATO: Il login ora è limitato SOLO ai social, senza telefono.
    ...
    <div className="app-container">
      ...
      <main className="main-content">
        <header className="header">
          ...
          <ConnectWallet 
            theme="dark" 
            btnTitle="Aziende: Accedi / Iscriviti"
            wallets={[
              inAppWallet({
                options: {
                  phone: false, // Disabilita esplicitamente il login con telefono
                  email: true,
                  google: true,
                  facebook: true,
                  apple: true,
...
// Assicurati di avere il codice completo dei componenti RegistrationForm e ActiveUserDashboard qui sotto.
