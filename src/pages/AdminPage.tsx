...
// QUESTA È LA VERSIONE FINALE E COMPLETA CON TUTTE LE FUNZIONALITÀ DI GESTIONE
    ...
    const fetchCompanies = useCallback(async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                throw new Error(data.error || "Errore sconosciuto nel caricare i dati.");
            }
        } catch (error) { console.error("Errore caricamento aziende:", error); setAllCompanies([]); }
        setIsLoading(false);
    }, []);
